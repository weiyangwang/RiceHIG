...
'/store/data/HIRun2011/HIHighPt/RECO/hiHighPtTrack-PromptSkim-v1/0000/9A6002CC-792A-E111-B936-00A0D1E95396.root'
...
process.pixeltrack_minbias_step = cms.Path(  process.eventFilter_minbias
                                   * process.siPixelRecHits
                                   * process.conformalPixelTrackReco
                                   * process.hiGoodTightMergedTracks
                                  )
process.pixeltrack_ucc_step = cms.Path(  process.eventFilter_ucc
                                   * process.siPixelRecHits
                                   * process.conformalPixelTrackReco
                                   * process.hiGoodTightMergedTracks
                                  )
...
process.schedule = cms.Schedule(
   ...
   process.pixeltrack_minbias_step,
   process.pixeltrack_ucc_step,
