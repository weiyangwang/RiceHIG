...
process.source = cms.Source("PoolSource",
  ...
  '/store/hidata/HIRun2011/HIMinBiasUPC/RECO/12Jun2013-v1/20000/004F3601-6AD5-E211-A21A-003048F317C0.root'
)
)
...
process.output_HM = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
      ...
      filterName = cms.untracked.string('PbPb_HM'))
)
process.output_HM.outputCommands.extend(cms.untracked.vstring('keep *_hiCentrality_*_RECO'))
process.output_HM.outputCommands.extend(cms.untracked.vstring('keep *_hiEvtPlane_*_RECO'))
