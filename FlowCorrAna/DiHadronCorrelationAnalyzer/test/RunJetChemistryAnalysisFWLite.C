...
#include "FlowCorrAna/DiHadronCorrelationAnalyzer/interface/JetChemistryAnalyzerFWLite.h"
#endif

void RunJetChemistryAnalysisFWLite(
           int ffrom, int fto,
           ...
           int centmin, int centmax)
{
  ...
  JetChemistryAnalyzerFWLite* corr = new JetChemistryAnalyzerFWLite(event);
  ...
  {
    cout<<"Running jet chemistry analysis in Heavy Ion!"<<endl;
  ...
  else cout<<"Running jet chemistry analysis in pp!"<<endl;
