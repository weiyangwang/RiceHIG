...
#include "FlowCorrAna/DiHadronCorrelationAnalyzer/interface/EPEtaDecoAnalyzerFWLite.h"
#endif

void RunEPEtaDecoAnalyzerFWLite(
           int ffrom, int fto,
           ...
           int centmin, int centmax)
{
  ...
  EPEtaDecoAnalyzerFWLite* corr = new EPEtaDecoAnalyzerFWLite(event);
