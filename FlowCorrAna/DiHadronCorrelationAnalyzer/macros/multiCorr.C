...
*/
  ...
  TString dataname = "PAData_Minbias_5TeV";
  TString datatag = "HM_PromptRecoNewFinal_All_INCLEFF1v66Kshort";
  TString datatag_periph = "MB_PromptRecoNew_INCLEFF1v61";
...
//  TString filename_ref = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/%s/merged/%s_%s_nmin%d_nmax%d_etatrg%.1f-%.1f_etaass%.1f-%.1f_centmin%d_centmax%d.root",dataname.Data(),dataname.Data(),"MB_PromptRecoNew_All_INCLEFF1ONEPTBINv11",nmultmin,nmultmax,-1,-1,-2.4,2.4,-2.4,2.4);
  TString filename_ref = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/%s/merged/%s_%s_nmin%d_nmax%d_etatrg%.1f-%.1f_etaass%.1f-%.1f_centmin%d_centmax%d.root",dataname.Data(),dataname.Data(),"HM_PromptRecoNew_INCLEFF1ONEPTBINv11",nmultmin,nmultmax,-1,-1,-2.4,2.4,-2.4,2.4);
...
//  TString filename_ref = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/%s/merged/%s_%s_nmin%d_nmax%d_etatrg%.1f-%.1f_etaass%.1f-%.1f_centmin%d_centmax%d.root",dataname.Data(),dataname.Data(),"MBpPb_INCLv61",nmultmin,nmultmax,-1,-1,-2.4,2.4,-2.4,2.4);

  TH1D* hdata_short_ref = (TH1D*)Get1DCFdPhiv3(filename_ref.Data(),0,0,-1,1);
  TH1D* hdata_long_ref = (TH1D*)Get1DCFdPhiv3(filename_ref.Data(),0,0,2,4);
  ...
  if(IsSubPeriph)
  {
    ...
    TString filename_ref_periph = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/%s/merged/%s_%s_nmin%d_nmax%d_etatrg%.1f-%.1f_etaass%.1f-%.1f_centmin%d_centmax%d.root",dataname.Data(),dataname.Data(),"MB_PromptRecoNew_All_INCLEFF1ONEPTBINv11",nmultmin_periph,nmultmax_periph,-1,-1,-2.4,2.4,-2.4,2.4);
//    TString filename_ref_periph = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/%s/merged/%s_%s_nmin%d_nmax%d_etatrg%.1f-%.1f_etaass%.1f-%.1f_centmin%d_centmax%d.root",dataname.Data(),dataname.Data(),"PPRereco_INCLEFF1ONEPTBINv11",nmultmin_periph,nmultmax_periph,-1,-1,-2.4,2.4,-2.4,2.4);

    hdata_short_ref_periph = (TH1D*)Get1DCFdPhiv3(filename_ref_periph.Data(),0,0,-1.0,1.0);
    hdata_long_ref_periph = (TH1D*)Get1DCFdPhiv3(filename_ref_periph.Data(),0,0,2,4);
...
//    gr_yield_short_pt->SetPointError(ibin,0,yielderror_short);
    ...
    if(IsSubPeriph)
    {
      TString filename_periph = Form("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/%s/merged/%s_%s_nmin%d_nmax%d_etatrg%.1f-%.1f_etaass%.1f-%.1f_centmin%d_centmax%d.root",dataname.Data(),dataname.Data(),datatag_periph.Data(),nmultmin_periph,nmultmax_periph,-1,-1,-2.4,2.4,-2.4,2.4);
      hdata_short_periph[ibin] = (TH1D*)Get1DCFdPhiv3(filename_periph.Data(),ibin,ptbin_ref,-1.0,1.0);
      hdata_long_periph[ibin] = (TH1D*)Get1DCFdPhiv3(filename_periph.Data(),ibin,ptbin_ref,2,4);
...
//    hdata_long_ref_zyam->Draw("PESAME");
  ...
  ofstream fcout(Form("data/v2v3vspt_%s_N%d%d_Kshort.txt",dataname.Data(),nmultmin,nmultmax));
...
//  ofstream fcout(Form("data/v2v3vspt_%s_N%d%d.txt",dataname.Data(),nmultmin,nmultmax));
  ...
  ofstream fcout(Form("data/NMultV2V3vspt_%s_N%d%d_Kshort.txt",dataname.Data(),nmultmin,nmultmax));
  fcout << "pt    V_0 " << endl;
  ...
  ofstream fcout(Form("data/JetYieldvspt_%s_N%d%d_Kshort.txt",dataname.Data(),nmultmin,nmultmax));
